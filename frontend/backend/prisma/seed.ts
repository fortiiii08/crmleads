import { PrismaClient, UserRole, ScriptCategory } from '@prisma/client';
  ...
  const scriptsData = [
    {
      ...
      category: ScriptCategory.FIRST_CONTACT,
      content: `Olá, {{nome}}! 👋
...
Quando seria um bom momento para conversarmos? ⏰`,
    ...
    },
    {
      ...
      category: ScriptCategory.SCHEDULING,
      content: `Olá {{nome}}!
...
Qual horário fica melhor para você?`,
    ...
    },
    {
      ...
      category: ScriptCategory.REACTIVATION,
